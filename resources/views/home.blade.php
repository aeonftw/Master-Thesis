                ...
                <form class="needs-validation" method="POST" action="/submitPost" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" required="required" class="form-control" placeholder="Post title" name="title" aria-label="title" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Details</span>
                            </div>
                            <textarea class="form-control" required="required" placeholder="Post details" name="content" aria-label="content"></textarea>
                        </div>
                        <div class="row">
    ...
    <div class="row justify-content-center">
        ...
        <div style="padding:0;" class="card col-md-2 mr-2 ml-2 mb-3">
            ...
            <div class="card-footer text-muted">
                ...
                @else
                <div class="text-left">Posted By: <a href="/author/{{$post->user_id}}">{{ $post->user->username }}</a></div>
                @endif
            </div>
