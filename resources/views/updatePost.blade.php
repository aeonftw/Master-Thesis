                ...
                <form class="needs-validation" novalidate method="POST" action="/updatePost" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" value="{{ $postData->title }}" required="required" class="form-control" placeholder="Post title" name="title" aria-label="title" aria-describedby="basic-addon1">
                        </div>
